...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('taggit_tag', 'ad_alias', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'taggit.tag': {
            ...
            'ad_alias': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '50', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
